...
| 2. Classification ablation | core screen complete; confirmation pending | Dataset/input contract frozen | Seed-42 screen complete; five-seed key groups and final classification report pending |
