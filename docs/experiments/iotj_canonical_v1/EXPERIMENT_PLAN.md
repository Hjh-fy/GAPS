...
- Classification: GAPS, TCN+attention, Adam 5e-4, 25 rounds, local epochs 1, batch size 32, seed 42. Only preprocessing and the explicit 50-point input contract differ from the prior frozen training protocol.
