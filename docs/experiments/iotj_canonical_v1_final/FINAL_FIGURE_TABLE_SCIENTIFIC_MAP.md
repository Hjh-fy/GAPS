...
| Table I | FedAvg/FedProx/SCAFFOLD/MMD/A0T/GAPS classification | `canonical_classification_comparison.csv` | `canonical_comparator_evaluation_manifest.json` | `scripts/evaluate_iotj_canonical_v1_comparators.py` | Include optimizer and target-information regime; A4 and A0T are effectively tied under equal label access at seed42 | READY_WITH_LIMITATION |
...
| Fig.6 | Strict non-overlap robustness | `strict_non_overlap_summary.csv`, `strict_non_overlap_deltas.csv`, `strict_nonoverlap_r84_summary.csv` | `strict_nonoverlap_r84_protocol_manifest.json` | strict builder/runner/analyzer | Sensitivity analysis; C5 triggers both preregistered collapse flags and must be shown explicitly | READY_WITH_BLOCKED_C5_CLAIM |
