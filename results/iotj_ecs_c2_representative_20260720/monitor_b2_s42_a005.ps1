...
$attempt = Join-Path $PSScriptRoot 'raw/c12_to_c5__b2__s42/c12_to_c5__b2__s42__a005'
...
do {
    Write-Output "===== $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') B2-s42/a005 ====="
    Get-Content -Raw -LiteralPath (Join-Path $attempt 'attempt_status.json')
